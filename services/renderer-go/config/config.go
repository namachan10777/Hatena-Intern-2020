...
func Load() (*Config, error) {
	...
	// TitleFetcherAddr
	titleFetcherAddr := os.Getenv("TITLE_FETCHER_ADDR")
	if titleFetcherAddr == "" {
		return nil, errors.New("TITLE_FETCHER_ADDR is not set")
	}
	conf.TitleFetcherAddr = titleFetcherAddr
